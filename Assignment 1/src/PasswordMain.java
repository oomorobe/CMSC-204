...
public class PasswordMain extends BorderPane
{
	...
	private class DisplayIllegalPasswords implements ActionListener {
	    ...
	    public void actionPerformed(ActionEvent theEvent) {
	        if (illegalPasswords.isEmpty()) {
	            alert.setContentText("No illegal passwords found.");
	        } else {
	            StringBuilder result = new StringBuilder("Illegal Passwords:\n");
	    ...
	    if (selectedFile != null) {
	        ...
	        try (Scanner input = new Scanner(selectedFile)) {
	            ...
	            if (illegalPasswords.isEmpty()) {
	                ...
	                results.append("Illegal Passwords:\n");
	                for (String passwordString : illegalPasswords) {
	                    results.append(passwordString).append("\n");
	                }
